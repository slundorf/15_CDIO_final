...
public class FakeSerProductBatchComponentDAO extends FakeSerDAO<ProductBatchDTO> implements IProductBatchComponentDAO {

	public FakeSerProductBatchComponentDAO(String pathName) {
		super(pathName);
	}

	public FakeSerProductBatchComponentDAO() {
	...
	public ProductBatchComponentDTO getProduktBatchComp(int pbId, int ingrId) throws DALException {
		...
		throw new DALException(
				"No Product batch found with id = " + pbId + " and ingredient id = " + ingrId);
	}
...
//			}
		...
		if (!existed) {
			throw new DALException("productBatch not found");
		}
		saveInfo();
	}
